...
def start(update: Update, context: CallbackContext):
    ...
    update.message.reply_text("Hello! I am your advanced AI assistant.", reply_markup=reply_markup)
...
def button_handler(update: Update, context: CallbackContext):
    ...
    if query.data == 'help':
        ...
        query.edit_message_text("Send /image <description> to generate an image.")
...
def generate_image(update: Update, context: CallbackContext):
    ...
    if not user_msg:
        ...
        return
    try:
        response = openai.Image.create(prompt=user_msg, n=1, size="512x512")
